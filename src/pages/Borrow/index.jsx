        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="right">borrowID</StyledTableCell>
              <StyledTableCell align="right">BorrowDate</StyledTableCell>
              <StyledTableCell align="right">ReturnData</StyledTableCell>
              <StyledTableCell align="right">status</StyledTableCell>
              <StyledTableCell align="right">UserID</StyledTableCell>
              <StyledTableCell align="right">EquipmentID</StyledTableCell>
          ...
          <TableBody>
            {borrow.map((row) => (
              <StyledTableRow key={row.BorrowID}>
                ...
                <StyledTableCell align="right">{row.BorrowID}</StyledTableCell>
                ...
                <StyledTableCell align="right">{row.EquipmentID}</StyledTableCell>
